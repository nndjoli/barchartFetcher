...
class Quotes:
    ...
    def analyst_rating(self, symbols: str = "AAPL", raw: int = 1):
        """Retrieve analyst ratings from barchart.com.
    ...
    def fundamentals(self, symbols: str = "AAPL", raw: int = 1):
        """Fundamental data for ``symbols`` from barchart.com.
    ...
    def options_overview(self, symbols: str = "AAPL", raw: int = 1):
        """Options overview information from barchart.com.
    ...
    def price_performance(self, symbols: str = "AAPL", raw: int = 1):
        """Price performance metrics for ``symbols`` from barchart.com.
    ...
    def quote(self, symbols: str = "AAPL", raw: int = 1):
        """Latest quote information for ``symbols`` from barchart.com.
    ...
    def lows_highs(self, symbols: str = "AAPL", raw: int = 1):
        """52-week lows and highs for ``symbols`` from barchart.com.
