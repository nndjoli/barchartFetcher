...
class Technicals:
    ...
    def moving_averages(self, symbols: str = "AAPL", raw: int = 1):
        """Moving average values for ``symbols`` from barchart.com.
    ...
    def stochastics(self, symbols: str = "AAPL", raw: int = 1):
        """Stochastic oscillator values for ``symbols`` from barchart.com.
    ...
    def strength(self, symbols: str = "AAPL", raw: int = 1):
        """Relative strength index for ``symbols`` from barchart.com.
