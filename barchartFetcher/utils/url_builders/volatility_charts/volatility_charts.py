...
def dte_histo_iv(symbol: str = 'AAPL', limit: str = '999', orderBy: str = 'date', orderDir: str = 'desc', groupBy: str = 'date') -> str:
...
def iv_rank_percentile(symbol: str = 'AAPL', limit: str = '360', orderBy: str = 'date', orderDir: str = 'desc') -> str:
    ...
    params = {
        ...
        'orderBy': orderBy,
        'orderDir': orderDir,
        'fields': 'impliedVolatilityRank1y,impliedVolatilityPercentile1y,totalVolume,totalOpenInterest,historicalLastPrice,date',
    }
    query = urlencode(params)
    return base_url + '?' + query
