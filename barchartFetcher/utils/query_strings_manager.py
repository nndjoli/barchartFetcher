def build_query_string_dictionary(QueryManager, complete_dataframe):
    ...
    for category in categories:
        ...
        category_fields_dataframe = fields_dataframe[
            fields_dataframe["category"] == category
        ]
        ...
        for subcategory in subcategories:
            ...
            subcategory_fields_dataframe = category_fields_dataframe[
                category_fields_dataframe["subcategory"] == subcategory
            ]
            subcategory_fields_list = subcategory_fields_dataframe[
                "apiField"
            ].tolist()
...
class QueryStringsManager:
    def __init__(self, QueryManager, complete_dataframe):
        self.complete_dataframe = complete_dataframe
        """Complete DataFrame with all fields."""
        self.query_strings_dict = build_query_string_dictionary(
            QueryManager, complete_dataframe
        )
